...
## function ERB_Hz(CF_Hz, ERB_break_freq = 1000/4.37 #= 228.833 =#, ERB_Q = 1000/(24.7*4.37) #= 9.2645 =# )
...
ERB_Hz(CF_Hz, ERB_break_freq, ERB_Q ) = begin

        @assert ERB_break_freq == 165.3
        @assert ERB_Q          == 1000/(24.7*4.37)
